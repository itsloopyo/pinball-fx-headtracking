...
An unofficial head tracking mod for Pinball FX that moves the camera with your head while your mouse or controller keeps control of the table, driven by OpenTrack over UDP, with no VR headset required.
